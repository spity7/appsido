          ...
          <div className="row">
            <div className="col-xxl-4 col-xl-2">
              <div className="studio-project-subtitle-box">
                <h3
                  className={`tp-section-subtitle-clash ${subtitleTextColor} mb-0`}
                >
                  Our <br /> case studies
                  <i>
                    <ArrowSvg
                      ...
                      height="9"
                      viewBox="0 0 102 9"
                      pathValue="M98 8L101.5 4.5L98 1M1 4H101V5H1V4Z"
                    />
                  </i>
                </h3>
              </div>
              ...
              <div className="studio-project-title-wrap">
                <div className="row align-items-end">
                  <div className="col-xl-8 col-lg-9">
                    <div className="studio-project-title-box">
                      {" "}
                      <h3 className="tp-section-title-clash mb-0 tp-text-revel-anim">
                        OUR RECENT PROJECTS
                      </h3>
                    </div>
                  </div>
                    ...
                    <div className="studio-project-number">
                      ...
                      <i>
                        <ArrowSvg
                          ...
                          height="9"
                          viewBox="0 0 202 9"
                          pathValue="M198 8L201.5 4.5L198 1M1 4H201V5H1V4Z"
                        />
                      </i>
                    </div>
