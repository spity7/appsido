...
const AboutModernHero = ({ heroTitle = "About Us" }) => {
  ...
  return (
    <div className="tp-hero-2-wrapper">
      <div
        className="tp-about-us-area include-bg pt-180 pb-150"
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-12">
              <div className="tp-hero-2-content text-center mb-25">
                <span
                  className="tp-hero-2-subtitle tp_fade_anim"
                  data-delay=".3"
                >
                  We specialize in delivering innovative IT solutions <br />
                  designed to meet the needs of a rapidly evolving digital
                  world.
                </span>
                <h1
                  ref={headingRef}
                  className="tp-hero-2-title about-us tp_fade_anim text-scale-anim"
                  data-delay=".5"
                >
                  {heroTitle}
                </h1>
          ...
          <div className="row">
            <div className="col-md-6">
              <div
                className="tp-hero-2-avater-box d-flex align-items-center justify-content-center justify-content-md-start tp_fade_anim"
                data-delay=".7"
              >
            ...
            <div className="col-md-6">
              <div
                className="tp-hero-2-btn-box tp-light-bg-btn text-center text-md-end tp_fade_anim"
                data-delay=".7"
              >
                <Link
