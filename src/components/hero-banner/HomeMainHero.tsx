...
const HomeMainHero = () => {
  return (
    <div
      className="tp-hero-area tp-hero-ptb tp-image-distortion p-relative fix z-index-1"
      style={{
          ...
          <div className="col-xl-9">
            <div className="tp-hero-title-box">
              <h2 className="tp-hero-title tp-char-animation">
                <span>Creative IT</span> <br />
                <span>
                  <Image
                    className="tp-hero-video d-none d-xl-inline-block"
                    src={heroVideoImg}
          ...
          <div className="col-xl-3">
            <div className="tp-hero-content-wrap d-flex flex-xl-column justify-content-between pb-20">
              <div className="tp-hero-info d-flex align-items-start justify-content-between tp_text_anim">
                <p>
                  We specialize in delivering <br /> innovative IT solutions
                  designed to meet the needs <br /> of a rapidly evolving
                  digital world.
                </p>
                <span>
                  <Link href="/contact">
                    <ArrowSvg
                      ...
                      color="currentcolor"
                      viewBox="0 0 22 22"
                      pathValue="M1 21L21 1M21 1H1M21 1V21"
                    />
                    <ArrowSvg
                      width="22"
                      height="22"
              ...
              <div
                className="tp-hero-more-info-wrap d-inline-flex justify-content-end tp_fade_anim"
                data-delay="1.5"
              >
                <div
                  className="tp-hero-more-info p-relative"
