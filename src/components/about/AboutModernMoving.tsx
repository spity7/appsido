        ...
        <div className="row justify-content-center">
          <div className="col-xl-12">
            ...
            <div className="des-about-text text-center">
              <p>
                To revolutionize the way businesses
                <span> leverage technology</span> , creating a future where
                <span> innovation drives</span> growth, efficiency, and
                sustainability. <br />
                To provide innovative, customized IT <span>solutions</span> that
                empower businesses to <span>thrive</span> in the digital age. We
                strive to be a trusted partner, delivering{" "}
                <span>excellence</span> at every step of the journey.
              </p>
            </div>
          </div>
        </div>
