...
const AboutModernSuccess: React.FC<IAboutModernSuccess> = ({
  bgColor = "#1B1B1D",
  spacingCls = "mb-70",
}) => {
  return (
          ...
          <div className="col-xl-6">
            <div className="row gx-10">
              <div className="col-xl-6 col-lg-6 col-md-6 mb-10">
                <div
                  className="crp-success-item about-us p-relative"
                  style={{
                    backgroundColor: bgColor,
                    backgroundImage: `url(${aboutUsThumb.src})`,
                  }}
                >
                  <div className="crp-about-us-item-wrap">
                    ...
                    <h4 className="crp-about-us-item-title">
                      Unique and <br />
                      New Business Tips
                    </h4>
              ...
              <div className="col-xl-6 col-lg-6 col-md-6 mb-10">
                <div
                  className="crp-success-item about-us-img p-relative"
