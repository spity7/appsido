"use client";
import logoWhite from "../../../public/assets/img/logo/appsido-white.svg";
import logoBlack from "../../../public/assets/img/logo/appsido-black.svg";
...
const HomeMainHeader = () => {
  ...
  return (
    <>
      <div
        className={`tp-header-area tp-header-ptb tp-header-blur sticky-white-bg
         header-transparent border-style-line tp-header-border ${
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-7 d-none d-xl-block">
              <div className="tp-header-box text-center">
                <div
                  className={`tp-header-menu tp-header-dropdown dropdown-white-bg`}
                >
